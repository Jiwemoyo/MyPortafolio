...
export const About = () => {
  ...
  return (
    <div className="bg-custom-blue flex flex-col gap-6 justify-center items-center h-screen px-8 text-center text-custom-celeste text-xl font-semibold sm:text-2xl sm:w-full sm:px-96">
      ...
      <h3 className="text-custom-red text-2xl font-bold sm:text-5xl mt-5">{t("carer-path")}</h3>
      ...
      <h3 className="text-custom-red text-2xl font-bold mt-5 sm:text-5xl">{t("skills")}</h3>
      ...
      <h3 className="text-custom-red text-2xl font-bold mt-5 sm:text-5xl">{t("Philosophy")}</h3>
